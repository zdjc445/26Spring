...
\clearpage
\begin{center}
{\zihao{3}\bfseries 参考答案}
\end{center}


\answerquestion{1}{词法分析详解}
...
\answerquestion{6}{Andersen 指针分析详解}
