...
\tableofcontents
\newpage
\section{编译原理 2025 风格模拟卷05（题目与考试标准答案）}
...
\begin{center}
\includegraphics[width=\linewidth]{figures/mock05-nfa.png}

\includegraphics[width=0.88\linewidth]{figures/mock05-dfa.png}

\includegraphics[width=0.88\linewidth]{figures/mock05-min-dfa.png}
\end{center}
