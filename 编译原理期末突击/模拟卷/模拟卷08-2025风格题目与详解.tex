...
\tableofcontents
\newpage
\section{编译原理 2025 风格模拟卷08（题目与考试标准答案）}
...
\subsection{七、PPT 新增重点：三地址码与控制流（10 分）}
...
\begin{enumerate}
\item 写出一种三地址码。
\item 标出循环测试、循环体和出口标签。
\item 说明条件跳转和无条件跳转分别在哪里使用。
...
\begin{center}
\includegraphics[width=\linewidth]{figures/mock08-nfa.png}

\includegraphics[width=0.88\linewidth]{figures/mock08-dfa.png}

\includegraphics[width=0.88\linewidth]{figures/mock08-min-dfa.png}
\end{center}
