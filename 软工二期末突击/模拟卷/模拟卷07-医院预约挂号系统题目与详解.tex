...
服务器端
  ...
  domain/entity
  modules
  patient doctor appointment payment refund
  database
\end{verbatim}
\end{quote}
...
AppointmentService -> Strategy/Domain: check rules and calculate result
...
HisDaoFactory -> PatientDao
HisDaoFactory -> AppointmentDao
NjuHisDaoFactory creates one product family
PartnerHisDaoFactory creates another product family
