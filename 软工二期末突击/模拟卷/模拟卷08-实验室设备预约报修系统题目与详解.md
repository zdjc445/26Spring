...
flowchart LR
    ...
    subgraph Server["服务器端"]
        ...
        modules["modules: device reservation repair maintenance notification"]
        database
    end
...
sequenceDiagram
    ...
    participant DeviceReservationService
    ...
    DeviceRepository-->>DeviceReservationService: domain object
    DeviceReservationService->>StrategyDomain: check rules and calculate result
    DeviceReservationService->>ExternalService: call external interface if needed
    ExternalService-->>DeviceReservationService: external result
...
classDiagram
    ...
    DeviceCollection ..> DeviceIterator : creates
    DeviceIterator <|.. AvailableDeviceIterator
    DeviceIterator <|.. NearestLabDeviceIterator
```
