...
flowchart LR
    ...
    subgraph Server["服务器端"]
        ...
        modules["modules: card recharge payment record user"]
        database
    end
...
sequenceDiagram
    ...
    CampusCardRepository-->>RechargeService: domain object
    RechargeService->>StrategyDomain: check rules and calculate result
    RechargeService->>ExternalService: call external interface if needed
    ExternalService-->>RechargeService: external result
