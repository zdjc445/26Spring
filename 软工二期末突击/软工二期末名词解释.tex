...
度量程序控制流复杂度。常用公式是 \texttt{V(G) = 判定节点数 + 1}。


\section{八、卷面速记}


\subsubsection*{需求层次判定句}
